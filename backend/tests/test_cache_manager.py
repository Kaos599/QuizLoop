...
async def test_cache_created_when_exceeding_10k_tokens():
    ...
    mock_cache.name = "cachedContents/skillforge-12345"
    ...
    with patch("app.services.cache_manager.get_gemini_client", return_value=mock_client):
        ...
        assert cache_name == "cachedContents/skillforge-12345"
...
async def test_cache_release_deletes_cache():
    ...
    with patch("app.services.cache_manager.get_gemini_client", return_value=mock_client):
        await release_document_cache("cachedContents/skillforge-12345")
        mock_client.aio.caches.delete.assert_called_once_with(name="cachedContents/skillforge-12345")
